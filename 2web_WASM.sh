...
FSEGT_PROJECT_COMPILE_FLAGS="-I../../FlameSteelFramework -I.. -o $FSEGT_PROJECT_NAME.html --bind -s WASM=1 -s ""BINARYEN_METHOD='native-wasm'"" --use-preload-plugins --preload-file data -s TOTAL_MEMORY=67108864 -O3 -ffast-math -std=c++11"
